         ...
         if (response.ok) {
            ...
            const aiMessage: ChatMessage = {
               ...
               content:
                  ...
                  "Não foi possível gerar a interpretação inicial.",
               timestamp: new Date(),
            };
                  ...
                  <Card>
                     ...
                     <CardContent className="space-y-4">
                           ...
                           <ScrollArea className="h-80 w-full rounded-md border p-4">
                              ...
                              <div className="absolute bottom-6 right-6 z-20">
                                 <Button
                                    ...
                                    style={{
                                       boxShadow:
                                          "0 4px 24px 0 rgba(80, 0, 200, 0.15)",
                        ...
                        <p className="text-xs text-gray-500 text-center pt-2">
                           Você pode perguntar sobre planetas, casas, aspectos
                           ou qualquer elemento do seu mapa.
                        </p>
                     </CardContent>
                  </Card>
               )}
